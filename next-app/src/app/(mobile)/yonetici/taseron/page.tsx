...
const STATUS_CONFIG: Record<string, { label: string; bg: string; text: string; dot: string; tabBg: string; tabText: string }> = {
  open:        { label: "Açık",         bg: "bg-amber-100",   text: "text-amber-700",  dot: "bg-amber-400",  tabBg: "bg-amber-500",   tabText: "text-amber-600"  },
  in_progress: { label: "Devam Ediyor", bg: "bg-blue-100",    text: "text-blue-700",   dot: "bg-blue-500",   tabBg: "bg-blue-500",    tabText: "text-blue-600"   },
  resolved:    { label: "Çözüldü",      bg: "bg-emerald-100", text: "text-emerald-700",dot: "bg-emerald-500",tabBg: "bg-emerald-500", tabText: "text-emerald-600"},
  cancelled:   { label: "İptal",        bg: "bg-gray-100",    text: "text-gray-500",   dot: "bg-gray-400",   tabBg: "bg-gray-400",    tabText: "text-gray-500"   },
};
...
export default function MobileTaseronListePage() {
  ...
  async function loadData() {
    ...
    const sorted = ((data || []) as ServiceRequest[]).sort(
